...
have a bunch of shells already open you can run the `SZ` (source zsh) alias to source new theme related configs.
...
```sh
BOOTSTRAP=1 bash <(curl -fsSL https://raw.githubusercontent.com/sassdavid/dotfiles/main/install)
```
